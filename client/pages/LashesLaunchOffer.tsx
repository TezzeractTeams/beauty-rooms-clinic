...
import { LashBookingFlow } from "@/components/lash/LashBookingFlow";
...
const LASH_GALLERY_IMAGES: { src: string; alt: string }[] = [
  { src: "/images/lashes-andrezza-1.png", alt: "Lash styling process at Beauty Rooms Clinic" },
  { src: "/images/lashes-andrezza-2.png", alt: "Close-up of finished lash result" },
  { src: "/images/lashes-andrezza-3.png", alt: "Andrezza working on customized lash set" },
  { src: "/images/lashes-andrezza-4.png", alt: "Before and after lash enhancement result" },
  { src: "/images/lashes-andrezza-5.png", alt: "Detailed lash extension application" },
];

const HERO_IMAGE = "/images/home-lashes.jpg";
const LASHES_BOOKING_SERVICE_ID = "urn:blvd:Service:786e1942-2960-4a0e-bb5d-f03ad53fe1e7";
const LASHES_BOOKING_SERVICE_NAME = "Lashes Launch Offer";
...
function scrollToBooking() {
  document.getElementById("lashes-lead-form")?.scrollIntoView({ behavior: "smooth", block: "start" });
}

function LashImageCarousel({ ariaLabel }: { ariaLabel: string }) {
  return (
    <ContinuousImageCarousel images={LASH_GALLERY_IMAGES} ariaLabel={ariaLabel} durationSeconds={40} />
  );
}

export default function LashesLaunchOffer() {
  return (
    <Layout>
      <article>
        <section className="w-full bg-[#FAFAF5]">
          <div className="flex min-h-[min(100dvh,720px)] flex-col md:min-h-[calc(100dvh-85px)] md:flex-row">
            <div className="flex w-full flex-col justify-center bg-[#FAFAF5] px-6 pb-10 pt-24 md:min-w-0 md:flex-[0_0_60%] md:max-w-[60%] md:py-16 md:pl-10 md:pr-8 lg:pl-14 lg:pr-10 xl:pl-20">
              <div className="mx-auto w-full max-w-2xl md:mx-0">
                ...
                <h1 className="mt-3 font-barlow font-extralight text-[clamp(36px,5vw,64px)] leading-none tracking-[-0.05em] text-charcoal md:mt-4">
                  Launch Special: Your First Full Set of Custom Lashes for $125.
                </h1>
                <p className="mt-4 font-barlow text-base font-light leading-[1.65] text-[rgba(45,41,38,0.78)] md:text-lg">
                  Save $25 for a limited time. Weightless, bespoke extensions designed for your unique eye shape for
                  effortless, mascara-free confidence.
                </p>
                <div className="mt-8">
                  <LashBookingFlow
                    anchorId="lashes-lead-form"
                    serviceId={LASHES_BOOKING_SERVICE_ID}
                    serviceName={LASHES_BOOKING_SERVICE_NAME}
                  />
                </div>
              </div>
            </div>
            <div className="relative min-h-[min(42vh,380px)] w-full md:min-h-[calc(100dvh-85px)] md:flex-[0_0_40%] md:max-w-[40%]">
              <img
                src={HERO_IMAGE}
          ...
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:items-start lg:gap-14">
            <div>
              ...
              <div className="overflow-hidden rounded-sm border border-[rgba(103,92,83,0.12)] bg-[#2a2a2a]">
                <img
                  src="/images/lashes-andrezza-process.png"
                  alt="Andrezza performing precise lash application"
          ...
          <div className="order-2 flex flex-1 flex-col justify-center px-8 py-12 md:order-1 md:px-12 lg:px-16 xl:px-20">
            <div className="mx-auto flex max-w-[540px] flex-col gap-5">
              ...
              <p className="font-barlow text-base font-light leading-[1.7] text-[rgba(45,41,38,0.72)]">
                Andrezza specializes in 100% bespoke eyelash extensions perfectly tailored to your unique eye shape.
                Driven by a passion for precision and client care, she ensures a superior standard of hygiene and
                results that prioritize the health of your natural lashes.
              </p>
            ...
            <div className={faqCardClass}>
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="safety" className="border-[rgba(103,92,83,0.12)]">
                  ...
                  <AccordionContent>
                    <p className="pb-2 font-barlow text-sm font-light leading-relaxed text-[rgba(45,41,38,0.78)]">
                      We isolate every natural lash and select appropriate weight and length. All treatments are
                      performed by certified specialists using professional-grade products.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="booking" className="border-[rgba(103,92,83,0.12)]">
                  ...
                  <AccordionContent>
                    <p className="pb-2 font-barlow text-sm font-light leading-relaxed text-[rgba(45,41,38,0.78)]">
                      Submit your details and choose your date and time directly in the booking calendar below.
                    </p>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
        ...
        >
          <p className="mx-auto max-w-3xl text-center font-barlow text-xs font-light leading-relaxed text-[rgba(45,41,38,0.65)] md:text-sm">
            This site is not part of the Meta website or Meta Platforms, Inc. All beauty treatments are performed by
