const labelClass =
  "mb-2 block font-barlow text-[11px] font-light uppercase tracking-[0.14em] text-warm-brown/85 md:text-xs";

const inputClass =
  "w-full border border-[rgba(103,92,83,0.22)] bg-[#FAFAF5] px-4 py-3.5 font-barlow font-light text-base text-charcoal placeholder:text-charcoal/30 shadow-none transition-colors focus:border-[rgba(103,92,83,0.45)] focus:outline-none focus:ring-1 focus:ring-warm-brown/25 [color-scheme:light]";
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl">
        ...
        <p className={`mb-10 max-w-2xl ${sectionIntroClass}`}>
        ...
        <div className="border border-[rgba(103,92,83,0.12)] p-8 shadow-[0_1px_0_rgba(255,255,255,0.5)_inset] md:p-10 [color-scheme:light]">
          ...
          >
            ...
            <div className="pt-2">
              <button
                type="button"
                className="inline-flex w-full items-center justify-center bg-primary px-10 py-5 font-barlow font-light text-xs uppercase tracking-[0.1em] text-primary-foreground opacity-50 cursor-not-allowed sm:w-auto"
                disabled
              >
                Submit application
              </button>
